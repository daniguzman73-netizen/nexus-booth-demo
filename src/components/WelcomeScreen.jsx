...
export default function WelcomeScreen({ onStart }) {
  ...
  return (
    <div className="relative kiosk-full bg-[#0D0A1A] flex flex-col overflow-hidden">
      ...
      <div
        ...
        style={{
          ...
          top: '-18%', left: '-8%',
          background: 'radial-gradient(circle, rgba(94,51,191,0.20) 0%, transparent 65%)',
          borderRadius: '50%',
        }}
      />
      <div
        ...
        style={{
          ...
          bottom: '0%', right: '-4%',
          background: 'radial-gradient(circle, rgba(94,51,191,0.14) 0%, transparent 65%)',
          borderRadius: '50%',
          animationDelay: '-2s',
        }}
      />
      <div
        ...
        style={{
          ...
          top: '35%', right: '18%',
          background: 'radial-gradient(circle, rgba(22,171,3,0.09) 0%, transparent 65%)',
          borderRadius: '50%',
        }}
      />
      ...
      <div className="relative z-10 flex items-center justify-between px-12 pt-10 pb-0">
        ...
        <div className="flex items-center gap-4">
          <NexusLogo size={48} />
          <div>
            <div className="text-white font-bold text-xl tracking-tight leading-tight">Nexus Extend</div>
            <div className="text-gray-500 text-sm tracking-wide">by Clarivate</div>
          </div>
        </div>

        {/* Conference badge */}
        <div className="flex items-center gap-3 border border-[#5E33BF]/30 bg-[#5E33BF]/10 rounded-xl px-5 py-2.5">
          <span className="text-[#a78bfa] text-sm font-semibold tracking-widest uppercase">ALA 2026</span>
        </div>
      </div>
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center text-center px-16">
        ...
        {/* Tag line */}
        <div className="mb-6 px-5 py-2 rounded-full border border-[#5E33BF]/35 bg-[#5E33BF]/12 inline-flex items-center gap-2">
          <span className="w-1.5 h-1.5 rounded-full bg-[#8B5CF6]" />
          <span className="text-[#a78bfa] text-base font-semibold tracking-widest uppercase">
        ...
        {/* Sub-headline */}
        <p className="text-[1.6rem] text-gray-400 mb-3 leading-relaxed max-w-2xl">
          Can you catch what AI gets wrong about citations?
        </p>
        <p className="text-[1.8rem] text-white font-semibold mb-14">
      ...
      {/* ── Bottom ticker ───────────────────────────────────────── */}
      <div className="relative z-10 bg-[#060412] border-t border-white/5">
        <div className="flex items-center gap-4 px-10 py-4">
          <span className="text-gray-600 text-sm font-semibold uppercase tracking-widest whitespace-nowrap flex-shrink-0">
            🏆 Today's Leader
          </span>
          <span className="w-px h-5 bg-white/10 flex-shrink-0" />

          <div className="flex-1 overflow-hidden">
            <span key={tickIdx} className="inline-block text-gray-400 text-base animate-fade-in">
              <span className="text-white font-semibold">{entry.name}</span>
              {' '}from{' '}
              <span className="text-gray-300">{entry.institution}</span>
              {' — '}
